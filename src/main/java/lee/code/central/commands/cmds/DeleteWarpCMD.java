...
public class DeleteWarpCMD extends CustomCommand {
  private final Central central;

  public DeleteWarpCMD(Central central) {
  ...
  public void perform(Player player, String[] args, Command command) {
    ...
    player.sendMessage(Lang.PREFIX.getComponent(null).append(Lang.COMMAND_DELETE_WARP_SUCCESSFUL.getComponent(new String[]{warpName})));
  }
