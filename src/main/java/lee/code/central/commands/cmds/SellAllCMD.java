...
public class SellAllCMD extends CustomCommand {
  private final Central central;

  public SellAllCMD(Central central) {
  ...
  public void perform(Player player, String[] args, Command command) {
    ...
    final int amount = ItemUtil.getItemAmount(player, handItem);
    ...
    ItemUtil.removePlayerItems(player, handItem, amount, false);
