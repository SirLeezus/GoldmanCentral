...
public class ArmorStandEditor extends MenuGUI {
        ...
        switch (armorStandPosition) {
            case BODY -> {
                switch (armorStandCoordinate) {
                    case X -> armorStand.teleport(new Location(armorStand.getWorld(), armorStand.getLocation().getX() + amount, armorStand.getLocation().getY(), armorStand.getLocation().getZ()));
                    case Y -> {
                    ...
                    case Z -> armorStand.teleport(new Location(armorStand.getWorld(), armorStand.getLocation().getX(), armorStand.getLocation().getY(), armorStand.getLocation().getZ() + amount));
                }
            }
            case HEAD -> {
                switch (armorStandCoordinate) {
                    case X -> armorStand.setHeadPose(new EulerAngle(armorStand.getHeadPose().getX() + amount, armorStand.getHeadPose().getY(), armorStand.getHeadPose().getZ()));
                    case Y -> armorStand.setHeadPose(new EulerAngle(armorStand.getHeadPose().getX(), armorStand.getHeadPose().getY() + amount, armorStand.getHeadPose().getZ()));
                    case Z -> armorStand.setHeadPose(new EulerAngle(armorStand.getHeadPose().getX(), armorStand.getHeadPose().getY(), armorStand.getHeadPose().getZ() + amount));
                }
            }
            case TORSO -> {
                switch (armorStandCoordinate) {
                    case X -> armorStand.setBodyPose(new EulerAngle(armorStand.getBodyPose().getX() + amount, armorStand.getBodyPose().getY(), armorStand.getBodyPose().getZ()));
                    case Y -> armorStand.setBodyPose(new EulerAngle(armorStand.getBodyPose().getX(), armorStand.getBodyPose().getY() + amount, armorStand.getBodyPose().getZ()));
                    case Z -> armorStand.setBodyPose(new EulerAngle(armorStand.getBodyPose().getX(), armorStand.getBodyPose().getY(), armorStand.getBodyPose().getZ() + amount));
                }
            }
            case RIGHT_LEG -> {
                switch (armorStandCoordinate) {
                    case X -> armorStand.setRightLegPose(new EulerAngle(armorStand.getRightLegPose().getX() + amount, armorStand.getRightLegPose().getY(), armorStand.getRightLegPose().getZ()));
                    case Y -> armorStand.setRightLegPose(new EulerAngle(armorStand.getRightLegPose().getX(), armorStand.getRightLegPose().getY() + amount, armorStand.getRightLegPose().getZ()));
                    case Z -> armorStand.setRightLegPose(new EulerAngle(armorStand.getRightLegPose().getX(), armorStand.getRightLegPose().getY(), armorStand.getRightLegPose().getZ() + amount));
                }
            }
            case LEFT_LEG -> {
                switch (armorStandCoordinate) {
                    case X -> armorStand.setLeftLegPose(new EulerAngle(armorStand.getLeftLegPose().getX() + amount, armorStand.getLeftLegPose().getY(), armorStand.getLeftLegPose().getZ()));
                    case Y -> armorStand.setLeftLegPose(new EulerAngle(armorStand.getLeftLegPose().getX(), armorStand.getLeftLegPose().getY() + amount, armorStand.getLeftLegPose().getZ()));
                    case Z -> armorStand.setLeftLegPose(new EulerAngle(armorStand.getLeftLegPose().getX(), armorStand.getLeftLegPose().getY(), armorStand.getLeftLegPose().getZ() + amount));
                }
            }
            case RIGHT_ARM -> {
                switch (armorStandCoordinate) {
                    case X -> armorStand.setRightArmPose(new EulerAngle(armorStand.getRightArmPose().getX() + amount, armorStand.getRightArmPose().getY(), armorStand.getRightArmPose().getZ()));
                    case Y -> armorStand.setRightArmPose(new EulerAngle(armorStand.getRightArmPose().getX(), armorStand.getRightArmPose().getY() + amount, armorStand.getRightArmPose().getZ()));
                    case Z -> armorStand.setRightArmPose(new EulerAngle(armorStand.getRightArmPose().getX(), armorStand.getRightArmPose().getY(), armorStand.getRightArmPose().getZ() + amount));
                }
            }
            case LEFT_ARM -> {
                switch (armorStandCoordinate) {
                    case X -> armorStand.setLeftArmPose(new EulerAngle(armorStand.getLeftArmPose().getX() + amount, armorStand.getLeftArmPose().getY(), armorStand.getLeftArmPose().getZ()));
                    case Y -> armorStand.setLeftArmPose(new EulerAngle(armorStand.getLeftArmPose().getX(), armorStand.getLeftArmPose().getY() + amount, armorStand.getLeftArmPose().getZ()));
                    case Z -> armorStand.setLeftArmPose(new EulerAngle(armorStand.getLeftArmPose().getX(), armorStand.getLeftArmPose().getY(), armorStand.getLeftArmPose().getZ() + amount));
                }
            }
        }
    }
    ...
    private double checkArmorStandPosition(ArmorStandPosition armorStandPosition, ArmorStandCoordinate armorStandCoordinate) {
        switch (armorStandPosition) {
            case BODY -> {
                switch (armorStandCoordinate) {
                    case X -> { return armorStand.getLocation().getX(); }
                    case Y -> { return armorStand.getLocation().getY(); }
                    case Z -> { return armorStand.getLocation().getZ(); }
                }
            }
            case HEAD -> {
                switch (armorStandCoordinate) {
                    case X -> { return armorStand.getHeadPose().getX(); }
                    case Y -> { return armorStand.getHeadPose().getY(); }
                    case Z -> { return armorStand.getHeadPose().getZ(); }
                }
            }
            case TORSO -> {
                switch (armorStandCoordinate) {
                    case X -> { return armorStand.getBodyPose().getX(); }
                    case Y -> { return armorStand.getBodyPose().getY(); }
                    case Z -> { return armorStand.getBodyPose().getZ(); }
                }
            }
            case RIGHT_ARM -> {
                switch (armorStandCoordinate) {
                    case X -> { return armorStand.getRightArmPose().getX(); }
                    case Y -> { return armorStand.getRightArmPose().getY(); }
                    case Z -> { return armorStand.getRightArmPose().getZ(); }
                }
            }
            case LEFT_ARM -> {
                switch (armorStandCoordinate) {
                    case X -> { return armorStand.getLeftArmPose().getX(); }
                    case Y -> { return armorStand.getLeftArmPose().getY(); }
                    case Z -> { return armorStand.getLeftArmPose().getZ(); }
                }
            }
            case RIGHT_LEG -> {
                switch (armorStandCoordinate) {
                    case X -> { return armorStand.getRightLegPose().getX(); }
                    case Y -> { return armorStand.getRightLegPose().getY(); }
                    case Z -> { return armorStand.getRightLegPose().getZ(); }
                }
            }
            case LEFT_LEG -> {
                switch (armorStandCoordinate) {
                    case X -> { return armorStand.getLeftLegPose().getX(); }
                    case Y -> { return armorStand.getLeftLegPose().getY(); }
                    case Z -> { return armorStand.getLeftLegPose().getZ(); }
                }
            }
        }
        return 0;
