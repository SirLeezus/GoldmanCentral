...
public enum Lang {
  ...
  COMMAND_RULES_TITLE("&a----------------- &e[ &c&lRules &e] &a-----------------"),
  COMMAND_RULES_LINE_1("&31&b. &eNo hacked clients."),
  COMMAND_RULES_LINE_2("&32&b. &eNo griefing other players."),
  COMMAND_RULES_LINE_3("&33&b. &eBe respectful to other players."),
  COMMAND_RULES_LINE_4("&34&b. &eDo not create server lag."),
  COMMAND_RULES_LINE_5("&35&b. &eDo not abuse bugs or exploits."),
  COMMAND_RULES_LINE_6("&36&b. &eReport bugs you find to staff."),
  COMMAND_RULES_WARNING("&cAny rule broken can result in a permanent ban."),
  COMMAND_RULES_FOOTER("&a--------------------------------------------"),
  ...
  COMMAND_HELP_VARIABLES_TITLE("&a------------ &e[ &#1AE7FF&lChat Variables &e] &a------------"),
  COMMAND_HELP_VARIABLES_LINE_1("&3[item] &b-> &eHand item info."),
  COMMAND_HELP_VARIABLES_LINE_2("&3[shop] &b-> &eYour player shop spawn."),
  COMMAND_HELP_VARIABLES_LINE_3("&3@PlayerName &b-> &eTags a player in global chat."),
  COMMAND_HELP_VARIABLES_FOOTER("&a-------------------------------------------"),
  COMMAND_HELP_VANILLA_TITLE("&a---------------- &e[ &#F3E5AB&lVanilla Changes &e] &a----------------"),
  ...
  COMMAND_HELP_LINE_5("&35&7. &#DF01DF&lTrails"),
  COMMAND_HELP_LINE_6("&36&7. &5&lPets"),
  COMMAND_HELP_LINE_7("&37&7. &9&lVault"),
  COMMAND_HELP_LINE_8("&38&7. &#0076CD&lResource Worlds"),
  COMMAND_HELP_LINE_9("&39&7. &#1AE7FF&lChat Variables"),
  COMMAND_HELP_LINE_10("&310&7. &#F3E5AB&lVanilla Changes"),
